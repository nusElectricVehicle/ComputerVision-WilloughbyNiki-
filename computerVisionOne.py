...
while True:
    ...
    print(imgWarp)
#look at the top left n bottom right
    #255 MAX out 8 bit val, st-ness or curv check it
    try:
        ...
        if averageCurve > 0:
            ...
            nums = "Curvature Detected"
            
        cv2.putText(imgFinal, str(nums), (frameWidth//2-70, 70), cv2.FONT_HERSHEY_DUPLEX, 1.75, (0, 0, 255), 2, cv2.LINE_AA)
